...
```text
Install Yinch Auto MKT from https://raw.githubusercontent.com/NetMindAI-Open/yinch-auto-mkt/main/install.sh . Put it into the default global directories for the current agent and fix the environment automatically: if you are Claude Code, configure ~/.claude/skills ~/.claude/commands ~/.claude/agents; if you are Codex, configure ${CODEX_HOME:-~/.codex}/skills; then run a health check.
```
